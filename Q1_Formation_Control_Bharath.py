...
3. Uses a distributed, graph-based formation-control law to steer the agents
   so that, collectively, their positions spell out "BHARATH", letter by
   letter: B -> H -> A -> R -> A -> T -> H.
...
-----------------------------------------------------------------------
    figures/q1_bharath_communication_graph.png
    figures/q1_bharath_formation_snapshots.png
    figures/q1_bharath_convergence.png
    figures/q1_bharath_formation_animation.mp4  (falls back to .gif if no ffmpeg)
"""
...
OUT_PREFIX = "q1_bharath"   # namespaces every output file for this name

# -----------------------------------------------------------------------
# 1. Name to simulate
# -----------------------------------------------------------------------
NAME_TO_SIMULATE = "BHARATH"
